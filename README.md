...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/async-lru-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10978&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/async-lru-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `async-lru` can be installed with:

```
conda install async-lru
```

It is possible to list all of the versions of `async-lru` available on your platform with:
